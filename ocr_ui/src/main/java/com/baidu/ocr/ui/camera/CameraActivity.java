...
public class CameraActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //手动输入,发送广播
        IdInput = findViewById(R.id.shoudongshuru);
        IdInput.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent("IdInput");
                intent.setPackage("com.example.dormitorysystem");
                sendBroadcast(intent);
            }
        });
        //返回按钮
        backBed = findViewById(R.id.back_bed);
        backBed.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
            }
